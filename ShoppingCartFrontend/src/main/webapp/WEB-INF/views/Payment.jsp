							...
							<form role="form" id="payment-form">
								...
								<div class="row">
									...
									<div class="col-xs-5 col-md-5 pull-right">
										<div class="form-group">
											<label >CVV/CVC</label> 
											<input type="text" class="form-control" name="cardCVC" placeholder="CVV/CVC" required />
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-xs-12">
										</a><button class="btn btn-success btn-lg btn-block" type="submit"><span class="glyphicon glyphicon-home"></span> Pay Rs ${purchase1.grandTotal}</button></a>
									</div>
								</div>
